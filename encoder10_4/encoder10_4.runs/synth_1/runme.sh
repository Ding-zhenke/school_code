...
HD_PWD='D:/FPGA/school_code/encoder10_4/encoder10_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e1.tcl
