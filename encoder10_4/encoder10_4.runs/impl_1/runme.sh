...
HD_PWD='D:/FPGA/school_code/encoder10_4/encoder10_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log e1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source e1.tcl -notrace
